# -*- coding: utf-8 -*-
"""
Created on Sat Sep 19 21:21:14 2020
...
#Loading the Data 
data = pd.read_excel(r'C:/Users/HP/Desktop/All Folders/Market Analysis/Excel files/Online_Retail_Store.xlsx') 
data.head() 
...
draw_graph (France_rules, 3)

draw_graph (Sweden_rules, 7)

draw_graph(UK_rules, 2)
